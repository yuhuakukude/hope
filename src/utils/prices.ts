...
const BASE_FEE = new Percent(JSBI.BigInt(0), JSBI.BigInt(10000))
  ...
  const realizedLPFee = !trade
    ...
    : ONE_HUNDRED_PERCENT.subtract(
        trade.route.pairs.reduce<Fraction>(
          (currentFee: Fraction): Fraction => currentFee.multiply(ONE_HUNDRED_PERCENT.subtract(feeRate ?? BASE_FEE)),
          ONE_HUNDRED_PERCENT
        )
      )
